// icon:bx-news | Boxicons https://boxicons.com/ | Atisa
import * as React from 'react';

function IconBxNews(props: any) {
    return (
        <svg viewBox="0 0 24 24" fill="currentColor" height="22px" width="22px" {...props}>
